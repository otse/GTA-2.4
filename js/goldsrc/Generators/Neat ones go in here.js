...
(function (Gens) {
    ...
    (function (GenFlats) {
        ...
        function type1(min, max) {
            ...
            Gens.loop(min, max, func);
        }
        GenFlats.type1 = type1;
    })(GenFlats = Gens.GenFlats || (Gens.GenFlats = {}));
    let GenRoads;
    (function (GenRoads) {
    ...
    })(GenRoads = Gens.GenRoads || (Gens.GenRoads = {}));
    let GenParking;
    (function (GenParking) {
    ...
    })(GenParking = Gens.GenParking || (Gens.GenParking = {}));
})(Gens || (Gens = {}));
export default Gens;
